var walletAddress = null, 
    ...
    contract = null,
    stakingAddress = "0x37424db01f322fd15c5deaecefe59d5dbeef3694",
    contractAddress = "0x71bEf356281711762F7629638A3eD06bD6f989b3",
    isMetaMask = true,
    web3 = null,
    web3Modal = null, 
    provider = null,
    ...
    function initialiseContracts() {
        ...
        getUserInfo().then(function(info) {
            ...
            var rewardsRemaining = info.rewardsRemaining / 10 ** 9;
            ...
            .then(function(res, err) {
                ...
                $(".stakeBtn").on("click", function() {
                    ...
                    if (isApproved) {
                        ...
                        let correctAmount = parseInt(tokenAmt.toString()) * 10 ** 9
